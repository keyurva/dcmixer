...
const file_stat_proto_rawDesc = "" +
	...
	"\apayload\x18\x02 \x01(\tR\apayload\"\xd2\x01\n" +
	"\bStatDate\x12S\n" +
...
var file_stat_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_stat_proto_goTypes = []any{
	...
	(*StatDate)(nil),                 // 14: datacommons.StatDate
	(*StatDateList)(nil),             // 15: datacommons.StatDateList
	nil,                              // 16: datacommons.PointStat.AttributesEntry
	nil,                              // 17: datacommons.SourceSeries.ValEntry
	nil,                              // 18: datacommons.SourceSeries.PlaceToLatestDateEntry
	nil,                              // 19: datacommons.Series.ValEntry
	(*ObsCollection_PlaceTypes)(nil), // 20: datacommons.ObsCollection.PlaceTypes
	nil,                              // 21: datacommons.ObsCollection.PlaceDcidToTypesEntry
	nil,                              // 22: datacommons.PlaceStat.StatVarDataEntry
	nil,                              // 23: datacommons.StatVarSeries.DataEntry
	nil,                              // 24: datacommons.StatDate.DatePlaceCountEntry
}
var file_stat_proto_depIdxs = []int32{
	...
	16, // 4: datacommons.PointStat.attributes:type_name -> datacommons.PointStat.AttributesEntry
	17, // 5: datacommons.SourceSeries.val:type_name -> datacommons.SourceSeries.ValEntry
	18, // 6: datacommons.SourceSeries.place_to_latest_date:type_name -> datacommons.SourceSeries.PlaceToLatestDateEntry
	19, // 7: datacommons.Series.val:type_name -> datacommons.Series.ValEntry
	...
	21, // 11: datacommons.ObsCollection.place_dcid_to_types:type_name -> datacommons.ObsCollection.PlaceDcidToTypesEntry
	...
	22, // 14: datacommons.PlaceStat.stat_var_data:type_name -> datacommons.PlaceStat.StatVarDataEntry
	23, // 15: datacommons.StatVarSeries.data:type_name -> datacommons.StatVarSeries.DataEntry
	24, // 16: datacommons.StatDate.date_place_count:type_name -> datacommons.StatDate.DatePlaceCountEntry
	0,  // 17: datacommons.StatDate.metadata:type_name -> datacommons.Facet
	14, // 18: datacommons.StatDateList.stat_date:type_name -> datacommons.StatDate
	20, // 19: datacommons.ObsCollection.PlaceDcidToTypesEntry.value:type_name -> datacommons.ObsCollection.PlaceTypes
