...
type GetVersionResponse struct {
	...
	// Spanner staleness timestamp
	SpannerStalenessTimestamp *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=spanner_staleness_timestamp,json=spannerStalenessTimestamp,proto3" json:"spanner_staleness_timestamp,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *GetVersionResponse) GetSpannerStalenessTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.SpannerStalenessTimestamp
	}
	return nil
}
...
const file_misc_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"misc.proto\x12\vdatacommons\x1a\x1fgoogle/protobuf/timestamp.proto\"\\\n" +
	...
	"\x0fdata_source_ids\x18\x06 \x03(\tR\rdataSourceIds\x12Z\n" +
	"\x1bspanner_staleness_timestamp\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x19spannerStalenessTimestampB0Z.github.com/datacommonsorg/mixer/internal/protob\x06proto3"
...
var file_misc_proto_depIdxs = []int32{
	...
	5, // 1: datacommons.GetVersionResponse.spanner_staleness_timestamp:type_name -> google.protobuf.Timestamp
